...
class LocationPickerSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sheetHeight = isKeyboardOpen
        ? (screenHeight * 0.86 - keyboardHeight)
            .clamp(screenHeight * 0.45, screenHeight * 0.68)
        : screenHeight * 0.58;

    final locState = context.read<LocationBloc>().state;
    final initialQuery = locState is LocationLoaded ? locState.searchQuery : '';
                    ...
                    children: [
                      LocationSearchHeader(
                        ...
                        onClearSearch: () {
                          context
                              .read<LocationBloc>()
                              .add(const FilterHotspotsEvent(query: ''));
                        },
